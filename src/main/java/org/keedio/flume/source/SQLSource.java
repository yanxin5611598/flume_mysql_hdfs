...
public class SQLSource extends AbstractSource implements Configurable, PollableSource {
    ...
    public void configure(Context context) {
        ...
        csvWriter = new MyCSVWriter(new ChannelWriter(),sqlSourceHelper.getDelimiterEntry().charAt(0));
...
//		   headers.put("file", "test_"+String.valueOf(System.currentTimeMillis()));
